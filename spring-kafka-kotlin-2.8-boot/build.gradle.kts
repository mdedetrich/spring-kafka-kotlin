...
dependencies {
    api(project(":spring-kafka-kotlin-2.8"))
    ...
    // "provided" pattern, same as spring-kafka-kotlin-2.8 itself: the consuming Spring Boot application
    ...
    kapt(libs.spring.boot.autoconfigure.processor.v28)
    ...
    testImplementation(libs.spring.boot.v28)
