 ...
 */
public data class SendAndReceiveResult<K : Any, V : Any, R : Any>(
 ...
 */
public suspend inline fun <reified P : Any, K : Any, V : Any, R : Any> ReplyingKafkaCoroutineOperations<K, V, R>.sendAndReceiveTyped(
    message: Message<*>,
 ...
 */
public inline fun <reified P : Any, K : Any, V : Any, R : Any> ReplyingKafkaCoroutineOperations<K, V, R>.sendAndReceiveDeferredTyped(
    message: Message<*>,
