...
dependencies {
    api(project(":spring-kafka-kotlin-3.3"))
    ...
    // "provided" pattern, same as spring-kafka-kotlin-3.3 itself: the consuming Spring Boot application
    ...
    compileOnly(libs.spring.boot.autoconfigure.v33)
    compileOnly(libs.spring.kafka.v33)
    // Generates META-INF/spring-autoconfigure-metadata.properties -- see the catalog alias's own doc.
    kapt(libs.spring.boot.autoconfigure.processor.v33)

    testImplementation(libs.spring.kafka.v33)
    testImplementation(libs.spring.boot.autoconfigure.v33)
    ...
    testImplementation(libs.spring.boot.v33)
    ...
    // other tests.
    testImplementation(libs.spring.boot.test.v33)
