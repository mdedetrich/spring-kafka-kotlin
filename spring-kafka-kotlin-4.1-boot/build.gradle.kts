...
dependencies {
    api(project(":spring-kafka-kotlin-4.1"))
    ...
    // "provided" pattern, same as spring-kafka-kotlin-4.1 itself: the consuming Spring Boot application
    ...
    compileOnly(libs.spring.boot.autoconfigure.v41)
    ...
    compileOnly(libs.spring.boot.kafka.v41)
    compileOnly(libs.spring.kafka.v41)
    // Generates META-INF/spring-autoconfigure-metadata.properties -- see the catalog alias's own doc.
    kapt(libs.spring.boot.autoconfigure.processor.v41)

    testImplementation(libs.spring.kafka.v41)
    testImplementation(libs.spring.boot.autoconfigure.v41)
    testImplementation(libs.spring.boot.kafka.v41)
    ...
    testImplementation(libs.spring.boot.v41)
    ...
    // other tests.
    testImplementation(libs.spring.boot.test.v41)
