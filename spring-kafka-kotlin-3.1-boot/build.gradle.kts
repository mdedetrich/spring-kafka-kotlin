...
dependencies {
    api(project(":spring-kafka-kotlin-3.1"))
    ...
    // "provided" pattern, same as spring-kafka-kotlin-3.1 itself: the consuming Spring Boot application
    ...
    compileOnly(libs.spring.boot.autoconfigure.v31)
    ...
    kapt(libs.spring.boot.autoconfigure.processor.v31)

    testImplementation(libs.spring.kafka.v31)
    testImplementation(libs.spring.boot.autoconfigure.v31)
    ...
    testImplementation(libs.spring.boot.v31)
    ...
    // other tests.
    testImplementation(libs.spring.boot.test.v31)
