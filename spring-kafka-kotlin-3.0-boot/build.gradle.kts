...
dependencies {
    api(project(":spring-kafka-kotlin-3.0"))
    ...
    // "provided" pattern, same as spring-kafka-kotlin-3.0 itself: the consuming Spring Boot application
    ...
    compileOnly(libs.spring.boot.autoconfigure.v30)
    compileOnly(libs.spring.kafka.v30)
    // Generates META-INF/spring-autoconfigure-metadata.properties -- see the catalog alias's own doc.
    kapt(libs.spring.boot.autoconfigure.processor.v30)
    ...
    testImplementation(libs.spring.boot.v30)
