...
private fun routingMockProducer(): MockProducer<Any, Any> =
    MockProducer(true, routingStringSerializerAsAny(), routingStringSerializerAsAny())
...
class RoutingKafkaCoroutineTemplateAutoConfigurationTest {
    ...
    // execute suspend @Test methods -- see KafkaCoroutineTemplateAutoConfigurationTest's identical note.
    @Test
    @Timeout(10)
