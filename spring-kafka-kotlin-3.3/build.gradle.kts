...
dependencies {
    ...
    // For the @KafkaListener coroutine-dispatch Aspect: provided by the consuming application, same
    // "provided" pattern as spring-kafka itself -- a real Spring Boot app normally gets both via
