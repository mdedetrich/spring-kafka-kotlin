 ...
 */
public class AggregatingReplyingKafkaCoroutineTemplate<K : Any, V : Any, R : Any>(
    ...
    // getSendFuture() is @Nullable on this version (was non-null through 3.3) -- see
    // ReplyingKafkaCoroutineTemplate's identical note for why !! is safe here and below.
    ...
    // assignedReplyTopicPartitions is @Nullable on this version -- see ReplyingKafkaCoroutineTemplate's
    // identical note.
